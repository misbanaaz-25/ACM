...
export default function WhitelistModal({ visible, onClose }: Props) {
 ...
 const handleAdd = () => {
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={handleClose}>
      {step === 'options' ? (
        // ----- Step 1: Add to whitelist by (options) -----
        <View style={styles.modalOverlay}>
          <View style={[styles.optionsBox, { backgroundColor: colors.white }]}>
            <Text style={[styles.optionsTitle, { color: colors.text }]}>Add to whitelist by</Text>
        ...
        >
          <View style={[styles.container, { width: width * 0.88, backgroundColor: colors.background }]}>
            ...
            <Text style={[styles.title, { color: colors.primary }]}>
              Enter the number you want to add to whitelist
            </Text>
            ...
            <View style={styles.buttonRow}>
              ...
              <TouchableOpacity
                ...
                onPress={handleAdd}
              >
                <Text style={[styles.addText, { color: colors.white }]}>Add to Whitelist</Text>
              </TouchableOpacity>
            </View>
